...
def show_all_docs_info():
    ...
    for current_document in documents:
        list_return.append(show_document_info(current_document))
    return list_return

#добавит новый документ в каталог и в перечень полок, спросив его номер, тип,
...
def secretary_program_start():
    ...
    while True:
        ...
        if user_command == 'p':
            ...
            list_return = show_all_docs_info()
            for ls in list_return:
                print(ls)
        elif user_command == 's':
            user_doc_number = input('Введите номер документа - ')
            ...
            user_doc_number = input('Введите номер документа - ')
            user_shelf_number = input('Введите номер полки для перемещения - ')
            chat = move_doc_to_shelf(user_doc_number, user_shelf_number)
            print(chat)
